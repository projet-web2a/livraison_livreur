...
<head>
	<title>EyeZone | Payment </title>

	<script language="javascript"> 
           function verifPay(){
	 if(payment.cardname.value=='')
	{
		alert("Entrer le nom du carte");
		return false;
	}
	else if (payment.cardnumber.value=='')
	{
	...
	else if(payment.cardDate.value=='')
	{
		return false;
	}
   /* for(i=0;i<6;i++)
    {
    	var exmonth=payment.cardDate.value[0]+payment.cardDate.value[1];
    	var exyear=payment.cardDate.value[3]+payment.cardDate.value[4];
    	var today = new Date();
