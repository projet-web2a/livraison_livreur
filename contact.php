				...
				<div class="address row">
					...
					<div class="col-lg-4 address-grid">
						<div class="row address-info">
							...
							<div class="col-md-9 address-right text-left">
								<h6>Address</h6>
								<p>Manar City 3th floor, Tunis</p>
							</div>
						</div>
					...
					<div class="col-lg-4 address-grid">
						<div class="row address-info">
							...
							<div class="col-md-9 address-right text-left">
								<h6>Email</h6>
								<p>Email <a href="mailto:example@email.com">eyezone@gmail.com</a> </p>
							</div>
					...
					<form action="#" method="post">
						<div class="row contact_left_grid">
							<div class="col-md-6 con-left">
								...
								<div class="form-group">
									<label class="my-2">Reference Produit</label>
									<input class="form-control" type="text" name="refe" placeholder="" required="">
								</div>
							</div>
