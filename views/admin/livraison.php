                    ...
                    <div class="card-body">
                     ...
                     <a class="btn btn-dark dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          ...
                          <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                              <a class="dropdown-item " href="livraison.php?maction=trier&par=idLivraison">Id Livraison</a>
                          ...
                          <?php foreach ($livraisons as $li) { ?>
                            <tr>
                              ...
                              <td>
                                  ...
                                  <a href="affecterLivreur.php?nom_ville=<?=$li['nom_ville']?>&id=<?=$li['idLivraison']?>" class="btn btn-danger">Affecter Livreur</a> </td>
